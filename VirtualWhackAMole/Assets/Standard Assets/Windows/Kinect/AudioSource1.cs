...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class AudioSource1 : Helper.INativeWrapper

    {
        ...
        internal AudioSource1(RootSystem.IntPtr pNative)
        {
            _pNative = pNative;
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache.RemoveObject<AudioSource1>(_pNative);
        ...
        private static void Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler(RootSystem.IntPtr result, RootSystem.IntPtr pNative)
        {
            ...
            lock(callbackList)
            {
                var objThis = Helper.NativeObjectCache.GetObject<AudioSource1>(pNative);
